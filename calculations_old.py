...
from constants import (
    PLANETS, H_NAMES, NIKUDIM, GIMATRIA, HEBREW_MONTHS, HEBREW_GIMATRIA_MAP,
    ...
    DIAGONAL_BOUNDARIES, ABILITIES, DAY_SERVANTS, NIGHT_SERVANTS
)
...
def calculate_temporary_time(now=None):
    ...
    try:
        ...
        if duration_seconds > 0:
            ...
            holy_combination = H_NAMES[temporary_hour % len(H_NAMES)]
    ...
    return (
        ...
        hebrew_date, zodiac_sign, parzuf_hashavua, sefirah_hayom, adnut_combination_1, adnut_combination_2,
