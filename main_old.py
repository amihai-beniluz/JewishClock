...
def create_full_ui(parent_frame, is_specific=False):
    ...
    global main_planet_servant_label
    ...
    right_col.grid(row=1, column=0, sticky="nsew", padx=(20, 10), pady=(10, 30))
    ...
    # כפתור תחתון (מוסר מהקוד הקודם כדי למנוע כפילות)
    if not is_specific:
        bottom_buttons_frame = tk.Frame(parent_frame, bg="#2c3e50")
        bottom_buttons_frame.grid(row=2, column=1, pady=(10, 40))
    ...
    tk.Label(day_week_frame, text="פרטי השבוע והיום", font=("Arial", 22, "bold"), fg="#ecf0f1", bg="#2c3e50").pack(
        pady=(0, 2))
    main_parzuf_label = tk.Label(day_week_frame, text="פרצוף השבוע: ?", font=("Arial", 18), fg="#ecf0f1", bg="#2c3e50")
    main_parzuf_label.pack(pady=2)
    main_sefirah_hayom_label = tk.Label(day_week_frame, text="ספירת היום: ?", font=("Arial", 18), fg="#ecf0f1", bg="#2c3e50")
    ...
    main_planet_label = tk.Label(hour_frame, text="כוכב: ?", font=("Arial", 18), fg="#ecf0f1", bg="#2c3e50")
    main_planet_label.pack(pady=1)
    main_planet_servant_label = tk.Label(hour_frame, text="משרת: ?", font=("Arial", 18), fg="#ecf0f1", bg="#2c3e50")
    main_planet_servant_label.pack(pady=1)
    main_tribe_label = tk.Label(hour_frame, text="שבט: ?", font=("Arial", 18), fg="#ecf0f1", bg="#2c3e50")
    main_tribe_label.pack(pady=1)
    main_stone_label = tk.Label(hour_frame, text="אבן: ?", font=("Arial", 18), fg="#ecf0f1", bg="#2c3e50")
    main_stone_label.pack(pady=1)
    main_house_label = tk.Label(hour_frame, text="בית: ?", font=("Arial", 18), fg="#ecf0f1", bg="#2c3e50")
    main_house_label.pack(pady=1)
    main_ability_label = tk.Label(hour_frame, text="פעולה: ?", font=("Arial", 18), fg="#ecf0f1", bg="#2c3e50")
    main_ability_label.pack(pady=1)
    main_diagonal_boundary_label = tk.Label(hour_frame, text="גבול אלכסון: ?", font=("Arial", 18), fg="#ecf0f1",
                                       bg="#2c3e50")
...
def update_main_ui():
    ...
    (temp_time_str, temp_hour_duration, temp_part_duration, _, _, _,
     ...
     zodiac_sign, parzuf_hashavua, sefirah_hayom, adnut_combination_1, adnut_combination_2, tribe_of_the_hour,
...
def update_local_time_main():
    ...
    (_, _, _, local_time_str, sunrise_str, sunset_str, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
     _, _, _) = calculate_temporary_time()
...
def create_full_ui_for_specific(parent_frame, labels_dict):
    ...
    right_col.grid(row=1, column=0, sticky="nsew", padx=(20, 10), pady=(70, 70))
    right_col.grid_columnconfigure(0, weight=1)
    ...
    left_col.grid(row=1, column=2, sticky="nsew", padx=(10, 20), pady=(70, 70))
    left_col.grid_columnconfigure(0, weight=1)
    ...
    tk.Label(day_week_frame, text="פרטי השבוע והיום", font=("Arial", 22, "bold"), fg=ECRU, bg=TURQUOISE).pack(
        pady=(0, 2))
    labels_dict["parzuf"] = tk.Label(day_week_frame, text="פרצוף השבוע: ?", font=("Arial", 18), fg=ECRU, bg=TURQUOISE)
    labels_dict["parzuf"].pack(pady=2)
    labels_dict["sefirah_hayom"] = tk.Label(day_week_frame, text="ספירת היום: ?", font=("Arial", 18), fg=ECRU,
                                            bg=TURQUOISE)
    ...
    labels_dict["planet"] = tk.Label(hour_frame, text="כוכב: ?", font=("Arial", 18), fg=ECRU, bg=TURQUOISE)
    labels_dict["planet"].pack(pady=1)
    labels_dict["planet_servant"] = tk.Label(hour_frame, text="משרת: ?", font=("Arial", 18), fg=ECRU, bg=TURQUOISE)
    labels_dict["planet_servant"].pack(pady=1)
    labels_dict["tribe"] = tk.Label(hour_frame, text="שבט: ?", font=("Arial", 18), fg=ECRU, bg=TURQUOISE)
    labels_dict["tribe"].pack(pady=1)
    labels_dict["stone"] = tk.Label(hour_frame, text="אבן: ?", font=("Arial", 18), fg=ECRU, bg=TURQUOISE)
    labels_dict["stone"].pack(pady=1)
    labels_dict["house"] = tk.Label(hour_frame, text="בית: ?", font=("Arial", 18), fg=ECRU, bg=TURQUOISE)
    labels_dict["house"].pack(pady=1)
    labels_dict["ability"] = tk.Label(hour_frame, text="פעולה: ?", font=("Arial", 18), fg=ECRU, bg=TURQUOISE)
    labels_dict["ability"].pack(pady=1)
    labels_dict["diagonal_boundary"] = tk.Label(hour_frame, text="גבול אלכסון: ?", font=("Arial", 18), fg=ECRU,
                                                bg=TURQUOISE)
...
def update_local_time_specific(labels, now):
    ...
    (_, _, _, local_time_str, sunrise_str, sunset_str, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
     _, _) = calculate_temporary_time(now=now)
